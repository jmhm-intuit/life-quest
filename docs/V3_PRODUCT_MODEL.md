...
- **Task** — concrete, schedulable work.
- **Quest** — meaningful initiative containing outcome and/or exploration work.
- **Habit** — recurring target that generates dated opportunities or numeric period progress.
- **Note** — idea, evidence, decision, or resource not yet requiring action.
